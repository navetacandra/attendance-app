...
const updateAttendanceValidation = Joi.object({
  ...
  status: Joi.string().valid("tepat", "telat", "sakit", "izin", "tanpa keterangan").required(),
});
...
export { attendanceValidation, updateAttendanceValidation, attendanceReportValidation };
